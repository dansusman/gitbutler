export enum TestId {
	...
	HunkSelectionPopover = "hunk-selection-popover",
	HunkSelectionPopover_Stage = "hunk-selection-popover-stage",
	HunkSelectionPopover_Comment = "hunk-selection-popover-comment",
	HunkSelectionPopover_Split = "hunk-selection-popover-split",
	HunkSelectionPopover_Cancel = "hunk-selection-popover-cancel",
